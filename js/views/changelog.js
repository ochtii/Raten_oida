...
function loadStaticChangelog(container) {
    ...
    const staticChanges = [
            ...
            version: '1.0.8.7',
            date: '2026-01-11',
            message: 'v1.0.8.6 final',
            details: 'v1.0.8.6 final',
            files: [],
        ...
        },
        {
            version: '1.0.8.5',
            date: '2026-01-11',
            message: 'chore: Final version sync v1.0.8.4',
            details: 'chore: Final version sync v1.0.8.4',
            files: [],
            stats: { additions: 0, deletions: 0 }
        },
        {
        ...
        },
        {
            ...
            details: 'fix: Auto Reload standardmäßig deaktiviert + Cleanup bei Seitenladung',
            files: [],
            stats: { additions: 0, deletions: 0 }
        },
        {
